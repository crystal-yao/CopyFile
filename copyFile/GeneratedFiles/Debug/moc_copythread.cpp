...
static const char qt_meta_stringdata_CopyThread[] = {
    "CopyThread\0\0value\0updateValue(QString)\0"
};
...
void CopyThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->updateValue((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    }
}

const QMetaObjectExtraData CopyThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject CopyThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_CopyThread,
      qt_meta_data_CopyThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CopyThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CopyThread))
...
// SIGNAL 0
void CopyThread::updateValue(QString _t1)
{
